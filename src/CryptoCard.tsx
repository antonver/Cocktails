...
export function CardPattern({ mouseX, mouseY, randomString }: any) {
  ...
  return (
      <div className="pointer-events-none">
        ...
        <motion.div
            className="absolute inset-0 bg-gradient-to-r from-purple-700 to-emerald-700 opacity-0 group-hover/card:opacity-100 backdrop-blur-xl transition duration-500"
            style={style}
        />
        <motion.div
